...
var questionArray = [
  ...
  [
    'Is my name Keri?',
    'answer1 correct answer was n or no, and user answered: ' + answer,
    [
      [
        'Sorry ' + userName + '. That was a trick question. It\'s Carrie not Keri',false
      ],
      [
        'Wrong ' + userName + '! They are named after physicists!',true,
        yesNo,false
      ],
...
for (i = 0; i < questionArray.length; i++) {
  ...
  if (answer === 'y' || answer === 'yes') {
    ...
    if(questionArray[i][2][0][1] === false) {
      tally++
    }
  } else if (answer === 'n' || answer === 'no'){
    alert(questionArray[i][2][1][0]);
    if(questionArray[i][2][1][1] === false) {
      tally++
    }
  } else {
    alert(questionArray[i][2][2][0]);
    if(questionArray[i][2][2][1] === false) {
      tally++
    }
  }
}
